    ...
    public class Game
    {
        ...
        private void CreateRooms()
        {
            ...
            outside.setDayDescriptions(
                ...
                "By now you should already know to pick up trash on your way to the Lobby, no? After that, head on to the Lobby (by typing 'm')"
            );
            lobby.setDayDescriptions(
                "Welcome, student! In Denmark, we sort trash by the materials it is made of! Simple, right?\nThe first sorting category is \x1b[93mMetal\x1b[39m. Try to (type) \"c\" and afterwards sort it into the \x1b[93mMetal\x1b[39m trash can (by typing \"1\")! When you have collected all the trash in the university the next day will begin. !\nMetal trash example: an empty beer can",
