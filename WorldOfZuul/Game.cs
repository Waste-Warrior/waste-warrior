    ...
    public class Game
    {
        ...
        private void CreateRooms()
        {
            ...
            outside.setDayDescriptions(
                ...
                "\x1b[96mTrash_buddy\x1b[39m: By now you should already know to pick up trash on your way to the Lobby, no? After that, head on to the Lobby (by typing 'm')"
            );
